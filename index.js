...
input.forEach(function(inputItem) {
   ...
   inputchildrensItem.childrens.forEach(function(inputchildrensInnerItem){
     let outputchildrensInnerItem ={};
 outputchildrensInnerItem.id = inputchildrensInnerItem.id;
 outputchildrensInnerItem.title = inputchildrensInnerItem.title;
 outputchildrensInnerItem.childrens = [];
 output.push(outputchildrensInnerItem);
 });
